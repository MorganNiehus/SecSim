...
//		example4();
	...
	private static void example1() {
		// Create an LinkedList of cities
	...
	private static void example2() {
		// Create an LinkedList of cities. Notice that a List can
	...
	private static void example4() {
	    ...
	    // Create new LinkedList from array.
	    LinkedList<String> cities2 = new LinkedList<>(Arrays.asList(aryCities));
	...
	private static void example5() {
	    ...
	    // Create a sublist. Note that the return is a List (not an LinkedList)		
	    ...
	    // However, we can use it to create an LinkedList if needed.		
	    LinkedList<String> cities2 = new LinkedList<>(subList);
	    
	    // Create another LinkedList. Note that we are referring to it as a "List".
	    // We don't have to, we could use LinkedList. We will say more later.
	    // "Collection"
	    AbstractList<String> cities3 = new LinkedList<>();
	    cities3.add("Phoenix");
	    cities3.add("New York");
	    cities3.add("Raleigh");
	    System.out.println("\ncities: " + cities );
